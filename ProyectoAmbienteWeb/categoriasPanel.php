    ...
    <section id="main-header" class="py-0">
        <div class="container" style="margin-top: 10px;">
            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="card">
                        ...
                        <a href="articulosPanel.php?categoria=bebidas" class="card-link">
                            <img class="card-img-top"
                                src="https://distritt.com/wp-content/uploads/2023/06/10-refrescos-con-mas-azucar-mexico-profeco.jpeg"
                ...
                <div class="col-3">
                    <div class="card">
                        <a href="@{/articulos/cereales}" class="card-link">
                            <img class="card-img-top"
                ...
                <div class="col-3">
                    <div class="card">
                        <a href="@{/articulos/frutas}" class="card-link">
                            <img class="card-img-top"
            ...
            <div class="row" style="margin-top: 10px;">
                <div class="col-3">
                    <div class="card">
                        <a href="@{/articulos/carnes}" class="card-link">
                ...
                <div class="col-3">
                    <div class="card">
                        <a href="@{/articulos/vegetales}" class="card-link">
                            <img class="card-img-top"
                ...
                <div class="col-3">
                    <div class="card">
                        <a href="@{/articulos/chocolates}" class="card-link">
                            <img class="card-img-top"
                ...
                <div class="col-3">
                    <div class="card">
                        <a href="@{/articulos/embutidos}" class="card-link">
                            <img class="card-img-top"
            ...
            <div class="row" style="margin-top: 10px;">
                ...
                <div class="col-3">
                    <div class="card">
                        <a href="@{/articulos/panaderia}" class="card-link">
                            <img class="card-img-top"
                ...
                <div class="col-3">
                    <div class="card">
                        <a href="@{/articulos/lacteos}" class="card-link">
                            <img class="card-img-top"
                ...
                <div class="col-3">
                    <div class="card">
                        <a href="@{/articulos/licores}" class="card-link">
                            <img class="card-img-top"
