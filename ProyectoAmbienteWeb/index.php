        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 my-2">
                    <a href="categoriasPanel.php" style="text-decoration: none;">
                        <div class="card">
                            <!-- Tarjeta 1 catalogo -->
                            <img class="card-img-top" src="img/home1.jpg" alt="catalogo" />
                            <div class="card-body">
                                <p class="card-text" style="font-family: Verdana, sans-serif;">Catalogo</p>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-md-4 my-2">
                    <a href="ventaFlashPanel.php" style="text-decoration: none;">
                        <div class="card">
                            <!-- Tarjeta 2 venta flash -->
                            <img class="card-img-top" src="img/home2.jpeg" alt="ventaflash" />
                            <div class="card-body">
                                <p class="card-text" style="font-family: Verdana, sans-serif;">Venta Flash</p>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-md-4 my-2">
                    <a href="promocionesPanel.php" style="text-decoration: none;">
                        <div class="card">
                            <!-- Tarjeta 3 promociones -->
                            <img class="card-img-top" src="img/home3.jpeg" alt="promociones" />
                            <div class="card-body">
                                <p class="card-text" style="font-family: Verdana, sans-serif;">Promociones</p>
                            </div>
                        </div>
                    </a>
                </div>
            ...
            <div class="card mb-3" style="max-width: 950px; margin-left: 150px; margin-top: 30px; text-align: center;">
                <div class="row g-0">
                    <div class="col-md-3">
                        <img src="img/home4.jpg" class="img-fluid rounded-start" alt=""
                    ...
                    <div class="col-md-3" style="width: 55.7%; margin-left: 160px; max-height: 200px; font-size: 15px;">
                        <div class="card-body">
                            ...
                            <p class="card-text">Una crujiente galleta de vainilla con deliciosa cobertura con sabor de
                                chocolate, La empresa Pozuelo lanzó una nueva oferta de galletas para el 2024, que
                                incluye nuevas versiones de sus clásicas Chiky y Cremas, así como el retorno de las
                                Toby. </p>
                            <a href="infoProducto.php?id_producto=5">
