                    ...
                    <div id="cardCredenciales" class="card bg-primary text-white">
                        <div class="row">
                            <div class="col-md-6" style="padding-top: 15px;">
                                ...
                                <input type="text" class="form-control custom-field" id="inputNombreCompleto"
                                    value="<?php echo $_SESSION['nombre']; ?>" readonly>
                            </div>
                            <div class="col-md-6" style="padding-top: 15px;">
                                <label for="inputEmail" class="form-label">Correo Electrónico</label>
                                <input type="email" class="form-control custom-field" id="inputEmail"
                                    value="<?php echo $_SESSION['correo']; ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6" style="padding-top: 15px;">
                                ...
                                ?>
                                <input type="text" class="form-control custom-field" id="inputCedula"
                                    value="<?php echo $formatoCedula; ?>" readonly>
                            </div>
                            <div class="col-md-6" style="padding-top: 15px;">
                                <label for="inputTelefono" class="form-label">Número de Teléfono</label>
                                <input type="text" class="form-control custom-field" id="inputTelefono"
                                    placeholder="Sin informacion..." value="<?php echo $_SESSION['numero_telefono']; ?>"
                                    readonly>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6" style="padding-top: 15px;">
                                ...
                                <textarea class="form-control custom-field" id="inputDireccionResidencia" rows="5"
                                    style="height: 80px;" placeholder="Sin informacion..."
                                    readonly><?php echo $_SESSION['direccion']; ?></textarea>
                            </div>
                            <div class="col-md-6" style="padding-top: 15px;">
                        ...
                        <div class="col-md-13 d-flex justify-content-end align-items-center">
                            <a href="perfilPanelM.php">
                                <button id="btnEditarGuardar" type="button" class="btn btn-dark card-button">Editar
                                    Perfil</button>
                            </a>
                        </div>
                    </div>
